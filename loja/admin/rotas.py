...
def home(): 
    ...
    return render_template('admin/index.html', title='Crypto$tore', produtos=produtos, categorias=categorias)
...
def obter_categoria(id):
    ...
    return render_template('admin/index.html', title='Crypto$tore', categorias1=categorias1 )
